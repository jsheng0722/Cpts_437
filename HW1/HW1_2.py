...
if __name__ == "__main__":
    ...
    #print("training_data after binning", training_data)
    ...
    # X = final_data[:,:-1]
    # y = modify_data[:,-1]
    #print("my train x: ", train_X)
    # print("my X's len: ", len(train_X))
    # print("my y: ", train_y)
    # print("my y's len: ", len(train_y))
    print("train feature num: ", len(training_data[0]))
    print("train data num: ", len(training_data))
    #print("my test x: ", test_X)
    # print("my X's len: ", len(test_X))
    # print("my y: ", test_y)
    # print("my y's len: ", len(train_y))
    print("train feature num: ", len(testing_data[0]))
    print("train data num: ", len(testing_data))
